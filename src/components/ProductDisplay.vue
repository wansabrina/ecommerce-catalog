<template>
    <div>
      ...
      <section class="wrapper">
        <div class="product-box">
          <Loader v-if="fetchStatus" /> <!-- Tampilkan loader saat fetchStatus true -->
  ...
  <script>
  import Loader from './Loader.vue'; // Impor komponen Loader
  ...
  export default {
    ...
    components: {
      UnavailableProduct,
      Loader, // Daftarkan komponen Loader di sini
    },
    data() {
      return {
        product: {},
